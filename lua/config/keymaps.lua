...
keymap('n', '<leader>gP', ':G push origin<CR>', { silent = true, desc = 'Git push' })
keymap('n', '<leader>gp', ':G pull --rebase origin<CR>', { silent = true, desc = 'Git pull --rebase' })
...
keymap('n', '<leader>gF', ':G push --force-with-lease origin<CR>', { silent = true, desc = 'Git push force with lease' })
